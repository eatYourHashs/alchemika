execute store result score $rand alch.dummy run random value 1..12
...
execute if score $rand alch.dummy matches 9 run function alchemika:item/notes/convert {ord:9,name:"pipes"}
execute if score $rand alch.dummy matches 10 run function alchemika:item/notes/convert {ord:10,name:"syringe"}
execute if score $rand alch.dummy matches 11 run function alchemika:item/notes/convert {ord:11,name:"burner"}
execute if score $rand alch.dummy matches 12 run function alchemika:item/notes/convert {ord:12,name:"bio_acid"}