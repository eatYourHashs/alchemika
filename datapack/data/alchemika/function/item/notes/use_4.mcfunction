...
execute if score @s alch.notes matches 19 unless entity @s[tag=alch.converted] run function alchemika:item/notes/convert {ord:20,name:"propellant_rocket"}

execute if score @s alch.notes matches 20.. run advancement grant @s only alchemika:alchemika/all_notes all_notes
# give random note if all tier 1 notes found
execute if score @s alch.notes matches 20.. unless entity @s[tag=alch.converted] run function alchemika:item/notes/random_4