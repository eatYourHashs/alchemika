...
execute if data entity @s item.components."minecraft:custom_data".alch_dat.cauldron[{id:"pyrotheum"}] run function alchemika:block/cauldron/heat
execute if data entity @s item.components."minecraft:custom_data".alch_dat.cauldron[{id:"cryofluid"}] run function alchemika:block/cauldron/interact/chill/check
