...
$execute store result score $temp.amount alch.dummy run data get entity @s item.components."minecraft:custom_data".alch_dat.cauldron[{id:"$(in_material_id)"}].amount
