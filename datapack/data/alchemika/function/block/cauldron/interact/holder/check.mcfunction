...
execute if score $temp.item_total alch.dummy matches 0 if score $temp.count alch.dummy matches 1.. run function alchemika:block/cauldron/interact/holder/fill_from_empty
