...
execute unless data storage alchemika:storage temp.item.components."minecraft:custom_data".alch_dat{list:['null']} if score $temp.iter alch.dummy matches 1.. run function alchemika:block/cauldron/interact/holder/iter_verify with storage alchemika:storage temp.cauldron_unclean[0]
