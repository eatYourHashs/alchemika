...
scoreboard players operation $temp.moved_amount alch.dummy = $temp.cauldron_amount alch.dummy
execute if score $temp.moved_amount alch.dummy >= $temp.item_remaining alch.dummy run scoreboard players operation $temp.moved_amount alch.dummy = $temp.item_remaining alch.dummy
scoreboard players operation $temp.cauldron_amount alch.dummy -= $temp.moved_amount alch.dummy
scoreboard players operation $temp.item_remaining alch.dummy -= $temp.moved_amount alch.dummy
scoreboard players operation $temp.item_total alch.dummy += $temp.moved_amount alch.dummy
