$execute if data storage alchemika:storage temp.item.components."minecraft:custom_data".alch_dat.list['$(id)'] run data modify storage alchemika:storage temp.cauldron append from storage alchemika:storage temp.cauldron_unclean[0]
