...
data remove storage alchemika:storage temp.item.components."minecraft:food"
data remove storage alchemika:storage temp.item.components."minecraft:consumable"
