...
execute at @s as @e[tag=alch.phial_rack_interaction,distance=..10] if data entity @s interaction at @s run function alchemika:block/phial_rack/interact/check
