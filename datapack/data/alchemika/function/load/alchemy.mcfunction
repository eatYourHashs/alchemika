...
data modify storage alchemika:registry alchemy.recipes.chill set value [{in1_material_id:"bio_acid",in2_material_id:"cryofluid",in3_material_id:"none",in1_material_amount:72,in2_material_amount:72,in3_material_amount:0,out1_material_id:"propellant",out2_material_id:"water",out1_material_amount:72,out2_material_amount:72}]
