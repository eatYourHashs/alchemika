...
data modify storage alchemika:registry materials merge value [{id:"molten_orichalcum",red:255,blue:40,green:80,tag:"hot",pure:"null"}]
...
data modify storage alchemika:registry recipes.ingot_cast merge value [{material_id:"molten_orichalcum",material_amount:144,loot:"alchemika:item/orichalcum_ingot"}]
