...
execute store result score $temp.existing alch.dummy run data get entity @s item.tag.alch_dat.cauldron[{id:"powder_snow"}].amount
execute store result score $temp.amount alch.dummy run data get entity @s item.tag.alch_dat.cauldron[{id:"powder_snow"}].amount
...
execute if score $temp.existing alch.dummy matches 1.. store result entity @s item.tag.alch_dat.cauldron[{id:"powder_snow"}].amount int 1 run scoreboard players get $temp.amount alch.dummy
