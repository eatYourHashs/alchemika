data modify entity @s HandItems[0].tag.alch_dat.potion.tag.CustomPotionEffects[{Duration:9600,Amplifier:0b}].Duration set value 24000
data modify entity @s HandItems[0].tag.alch_dat.potion.tag.CustomPotionEffects[{Duration:2400,Amplifier:0b}].Duration set value 6000
