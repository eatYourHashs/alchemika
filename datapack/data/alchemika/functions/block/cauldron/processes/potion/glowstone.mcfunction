data modify entity @s HandItems[0].tag.CustomPotionEffects[{Amplifier:0b,Duration:3600}].Amplifier set value 1b
data modify entity @s HandItems[0].tag.CustomPotionEffects[{Amplifier:0b,Duration:900}].Amplifier set value 1b
data modify entity @s HandItems[0].tag.CustomPotionEffects[{Amplifier:0b,Duration:1}].Amplifier set value 1b
