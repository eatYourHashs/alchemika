...
execute if score $temp.count alch.dummy matches 1.. run function alchemika:block/cauldron/interact/ingot_cast/iterate with storage alchemika:storage temp.cauldron[0]
