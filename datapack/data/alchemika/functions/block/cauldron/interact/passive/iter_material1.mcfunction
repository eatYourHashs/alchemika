...
$execute store result score $temp.recipe_count alch.dummy run data modify storage alchemika:storage temp.matched_recipes append from storage alchemika:registry recipes.passive[{in1_material_id:"$(id)"}]
