...
$execute unless score $temp.amount alch.recipe_count matches 0 run function alchemika:block/cauldron/interact/stir/iter_recipe with storage alchemika:storage temp.matched_recipes[0]
