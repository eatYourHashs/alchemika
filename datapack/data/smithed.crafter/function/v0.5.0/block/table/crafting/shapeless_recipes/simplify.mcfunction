...
execute if data storage smithed.crafter:main root.temp.shapeless_crafting_input[] run function smithed.crafter:v0.5.0/block/table/crafting/shapeless_recipes/main
